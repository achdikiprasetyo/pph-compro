    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>HOTEL NEO GUBENG, SURABAYA</li>
                <li>HOTEL ALANA MALANG</li>
                <li>ASTON HOTEL SIDOARJO</li>
                <li>HOTEL HORISON PASURUAN</li>
                <li>FAVE HOTEL SIDOARJO</li>
                <li>PURIMAS APARTEMENT SURABAYA</li>
                <li>CV. GREENSMART KEBARON, SURABAYA</li>
                <li>CV. GREENSMART HEAVELAND, SIDOARJO</li>
                <li>CV. GREENSMART TANDES, SURABAYA</li>
                <li>CV. GREENSMART LAVEST, SIDOARJO</li>
                <li>CV. GREENSMART NATURA, SIDOARJO</li>
                <li>CV. GREENSMART SAFIRA, SIDOARJO</li>
                <li>CV. GREENSMART SIDOMULYO, SURABAYA</li>
                <li>PCM MUHAMMADIYAH WONOKROMO, SURABAYA</li>
                <li>SD MUHAMMADIYAH 3 SURABAYA</li>
                <li>PT. AKSARA GRAFIKA, SURABAYA</li>
                <li>PT. PRIMA CITRA NUTRINDO, SURABAYA</li>
                <li>PT. ANUGERAH MATAHARI GEMILANG, SURABAYA</li>
                <li>JIVA AGRICULTURE INDONESIA, SIDOARJO</li>
                <li>DRIYOREJO KENCANA PERMAI, GRESIK</li>
                <li>PT. LOOKMAN DJAJA, SURABAYA</li>
                <li>PT. SINKO PRIMA ALLOY, SURABAYA</li>
                <li>PT. DAUN MAS NUSANTARA, SURABAYA</li>
                <li>PT. BENTENG API TEKNIK, GRESIK</li>
                <li>PT. NIPPON INDOSARI CORPINDO. TBK, PASURUAN</li>
                <li>PT. HUTOMO MANDALA RAHARJA, SURABAYA</li>
                <li>KLINIK ESTETIKA, SURABAYA</li>
                <li>BALAI BESAR KEKARANTINAAN KESEHATAN, SURABAYA</li>
                <li>BALAI KEKARANTINAAN KESEHATAN KELAS 1, PROBOLINGGO</li>
