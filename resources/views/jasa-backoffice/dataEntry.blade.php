...
<div class="container-jasa">
    <div class="left-container">
        ...
        <div class="row animated-element" data-animation="fadeIn">
            <div class="col-md-12">
            <p class="description">
                Layanan Tenaga Data Entry merupakan tim atau individu yang memiliki tanggung jawab untuk memasukkan, memperbarui, dan mengelola data ke sistem komputer atau basis data. Dengan begitu anda tidak perlu lagi memikirkan bagaimana cara memasukkan data yang sangat banyak dan kompleks, layanan kami hadir untuk menangani permasalahan tersebut.
            </p>
            <p class="description">
