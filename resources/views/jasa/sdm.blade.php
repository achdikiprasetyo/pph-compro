...
@section('content')
    <div class="container-jasa animated-element">
        <div class="left-container">
            ...
            <p class="description">
                Di layanan pelatihan Sumber Daya Manusia, kami mengajak anda untuk menjadikan mitra untuk mengoptimalkan Sumber Daya Manusia yang ada di perusahaan anda. Perusahaan kami tidak hanya menawarkan jasa pelatihan yang standar, melainkan kami juga melayani kebutuhan pelatihan perusahaan anda yang lainnya.
            <p class="description">
