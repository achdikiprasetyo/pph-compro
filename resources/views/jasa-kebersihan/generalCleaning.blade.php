...
<div class="container-jasa">
    <div class="left-container">
        ...
        <div class="row animated-element" data-animation="fadeIn">
            <div class="col-md-12">
            <p class="description">
                General Cleaning merupakan sebuah kegiatan pembersihan secara menyeluruh disuatu area atau bangunan yang perlu dilakukan secara berkala, agar area atau bangunan tersebut terhindar dari kerusakan, terlihat lebih nyaman dan bersih. General Cleaning merupakan sebuah layanan yang pasti dibutuhkan oleh individu ataupun perusahaan untuk menjaga kebersihan lingkungannya.
            </p>
            <p class="description">
                Apabila perusahaan Anda mencari solusi pembersihan yang handal, maka layanan kami adalah jawabanya. Layanan kami menyediakan general cleaning yang tidak hanya memberisihkan, melainkan juga menciptakan lingkungan yang sehat dan nyaman untuk perusahaan Anda.
            </div>
    </div>
</div>
